...
export const FINAL_EXTRA = `This is the end of the conversation. Repond your with your takaways as you finish the conversation. At the end of your response MAKE SURE to include your final evacuation decision: <<YES>> or <<NO>>.`;

const outputRules = `Respond as part of a natural conversation. DO NOT ADD ACTIONS OR STAGE DIRECTIONS. DO NOT SAY "I THINK" OR "I FEEL". JUST SAY WHAT YOU THINK AND FEEL AS IF YOU ARE TALKING TO THE OTHER RESIDENTS. SPEAK ONLY AS YOURSELF AND REPOND ONLY IN TEXT RESPONSE. MAKE SURE YOUR RESPONSES ARE SHORT AS PART OF A CONVERSATION AND NOT LONG MONOLOGUES. DO NOT WRITE DIALOGUE FOR OTHER CHARACTERS. RESPOND ONLY AS YOURSELF IN A SINGLE TURN.`;
